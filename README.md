...
[![Build Status](https://travis-ci.org/kissybnts/swagger-auto-pr-sample.svg?branch=master)](https://travis-ci.org/kissybnts/swagger-auto-pr-sample)
...
6. If you did everything correct, https://kissybnts.github.io/swagger-auto-pr-sample/ will lead to your new docs
...
- Documentation(ReDoc): https://kissybnts.github.io/swagger-auto-pr-sample/
- SwaggerUI: https://kissybnts.github.io/swagger-auto-pr-sample/swagger-ui/
- Look full spec:
    + JSON https://kissybnts.github.io/swagger-auto-pr-sample/swagger.json
    + YAML https://kissybnts.github.io/swagger-auto-pr-sample/swagger.yaml
- Preview spec version for branch `[branch]`: https://kissybnts.github.io/swagger-auto-pr-sample/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://kissybnts.github.io/swagger-auto-pr-sample/ with url from the message: `Server started <url>`
